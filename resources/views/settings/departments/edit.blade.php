<x-app-layout>
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900">Edit: {{ $department->name }}</h1>
    </div>

    <div class="max-w-lg">
        <form method="POST" action="{{ route('app.settings.departments.update', $department) }}">
            @csrf @method('PUT')
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 space-y-4">
                ...
                <div class="flex gap-3 pt-1">
                    <button type="submit" class="px-4 py-2 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800">Update Department</button>
